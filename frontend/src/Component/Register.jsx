...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FFE1D6]">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md border border-[#FF7E67]/20">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              type="text"
              className="w-full px-4 py-2.5 border border-amber-200 rounded-lg focus:outline-none focus:border-[#FF7E67] focus:ring-1 focus:ring-[#FF7E67] bg-amber-50/50 text-amber-900"
              value={name}
          ...
          <button
            type="submit"
            className="w-full bg-[#FF7E67] text-white py-3 rounded-lg hover:bg-[#FF6C85] transition-colors duration-300 font-medium mt-2"
          >
            Create Account
          </button>
        </form>
        <p className="text-center text-amber-900 mt-6">
          ...
          <a href="/login" className="text-[#FF7E67] hover:underline font-medium">
            Log In
          </a>
        </p>
      </div>
