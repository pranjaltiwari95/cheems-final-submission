...
const AppointmentTrainerTable = () => {
  ...
  // Fetch trainer appointments and sort by date (newest to oldest)
  useEffect(() => {
    const fetchTrainerAppointments = async () => {
      try {
        const url = `${API_URL}/api/appointments/trainer-appointments`;
  ...
  return (
    <div className="container mx-auto p-6 bg-gradient-to-br from-[#FFEADF] to-[#FFE1D6] min-h-screen relative">
        ...
        <table className="w-full table-fixed">
          <thead className="bg-amber-950 text-white">
            <tr>
              ...
              <th className="w-[120px] px-4 py-3 text-left text-xs font-medium uppercase tracking-wider">Trainer ID</th>
            ...
            {filteredAppointments.length === 0 ? (
              ...
              filteredAppointments.map((appointment, index) => (
                ...
                >
                  ...
                  <td className="w-[120px] px-4 py-3 text-sm truncate">{appointment.trainerId || 'N/A'}</td> {/* Corrected to trainerId */}
...
export default AppointmentTrainerTable;