...
export default function EventForm({ event, onSave }) {
  ...
  return (
    <section className="bg-gradient-to-br from-[#FFEADF] to-[#FFE1D6] min-h-screen pt-32 pb-20">
      <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
        <div className="bg-white/80 rounded-2xl shadow-lg p-8 border border-amber-100">
          <div className="bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] py-6 px-8 rounded-t-xl mb-6">
          ...
          <form onSubmit={handleSubmit} className="p-0 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="relative">
                ...
                <input
                  ...
                  } rounded-xl focus:outline-none focus:ring-2 focus:ring-[#FF7E67] focus:border-transparent text-base`}
                />
                {errors.title && (
            ...
            <div className="pt-4">
              <button
                ...
                className={`w-full px-6 py-3 rounded-xl text-base font-medium text-white transition duration-300 transform hover:scale-105 shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#FF7E67] ${
                  isFormValid()
