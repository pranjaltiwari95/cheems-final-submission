...
export default function Grid() {
  return (
    <div className="bg-gradient-to-br from-[#FFEADF] to-[#FFE1D6] py-24 sm:py-32 relative overflow-hidden">
      {/* Background decorative elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-[#FF5C7A]/10 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-[#FF7E67]/10 rounded-full blur-3xl"></div>
      </div>

      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8 relative">
        <div className="text-center mb-16">
          <h2 className="text-xl font-semibold text-[#FF5C7A] mb-3">Adopt Your Perfect Companion</h2>
        ...
        <div className="mt-16 grid gap-6 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
          {[
            ...
            >
              ...
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[#FF7E67]/20 to-[#FF5C7A]/20 p-[1px]">
                ...
                <div className="px-8 pt-8 pb-4 sm:px-10 sm:pt-10">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="p-2 bg-[#FF5C7A]/10 rounded-xl">
                      <step.icon className="w-6 h-6 text-[#FF5C7A]" />
                    </div>
                    <p className="text-xl font-bold text-[#FF5C7A] max-lg:text-center">
                      {step.title}
                    </p>
                  </div>
