      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
          ...
          <select
            ...
            className="border border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#FF7E67] focus:border-transparent text-base"
          >
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredAttendees.map((attendee) => (
            <div
              key={attendee._id}
              className="bg-gray-50 p-4 rounded-xl border-l-4 border-[#FF7E67] hover:shadow-md transition-all duration-300 relative"
            >
              <div className="flex items-center space-x-4">
                <div className="w-10 h-10 bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white rounded-full flex items-center justify-center font-bold">
                  ...
                  <div className="flex flex-col space-y-1 mt-1">
                    ...
                    {attendee.status === "cancelled" && (
                      <div className="text-sm text-gray-500 mt-1 space-y-1">
                        ...
                        <p>
                          Refund: {attendee.refundAmount.toLocaleString("en-IN", {
                            style: "currency",
                            currency: "INR",
                          })}
                        </p>
          ...
          <div className="bg-white rounded-2xl p-6 max-w-lg w-full shadow-lg border border-amber-100">
            ...
            <div className="mt-6 flex justify-end">
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white rounded-xl hover:bg-[#2D1B3D] transition duration-300 transform hover:scale-105 shadow-md hover:shadow-lg"
              >
                Close
              </button>
            </div>
