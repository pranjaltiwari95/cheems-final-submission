    ...
    <div className="min-h-screen bg-gradient-to-br from-[#FFEADF] to-[#FFEADF] py-8 mt-20">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-[#2D1B3D] mb-4">Lost & Found Pets</h1>
            ...
            <button
              ...
              className={`px-6 py-3 rounded-xl transition-colors flex items-center gap-2 shadow-lg transform transition-all duration-300 ${
                activeTab === 'lost'
                  ...
                  : 'bg-white text-[#2D1B3D] hover:bg-gray-100'
              }`}
            >
              <MapPin size={20} />
              Lost Pets
        ...
        <div className="mb-8 max-w-xl mx-auto">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#FF7E67] focus:border-transparent"
              value={searchQuery}
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-end">
                    <button
                      ...
                      className="bg-[#FF7E67] text-white px-4 py-2 rounded-lg hover:bg-[#2D1B3D] transition-colors"
                    >
                      View Details
                    </button>
                  </div>
