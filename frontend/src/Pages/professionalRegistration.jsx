...
const ProfessionalRegistration = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFE6DD] to-[#FFD8CC] flex flex-col">
      {/* Header */}
        ...
        <div className="w-full max-w-6xl bg-white shadow-2xl rounded-3xl overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 p-6 sm:p-12 overflow-y-auto max-h-screen">
            <div className="flex items-center justify-center mb-6 sm:mb-8">
              <Heart className="text-[#FF5C7A] mr-3" size={32} />
              <h2 className="text-2xl sm:text-3xl font-bold text-[#FF5C7A]">Professional Registration</h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              <div>
                ...
                <input
                  ...
                  } focus:outline-none focus:ring-2 focus:ring-[#C26E8E]`}
              ...
              <div>
                ...
                <select
                  ...
                  value={formData.role}
                  onChange={handleChange}
                  className="w-full px-4 py-1.5 rounded-xl border-2 border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#C26E8E]"
                >
              ...
              <div className="flex justify-center pt-4">
                <button
                  type="submit"
                  className="w-full bg-[#FF5C7A] text-white px-8 py-3 sm:py-4 rounded-xl text-md sm:text-lg font-semibold hover:bg-[#3B1E3D] transition-colors"
                >
                  Register
                </button>
              </div>
