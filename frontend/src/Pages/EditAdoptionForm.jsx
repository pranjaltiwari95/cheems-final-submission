    ...
    <div className="min-h-screen bg-gradient-to-br from-[#FFE6DD] to-[#FFD8CC] pt-24 p-6">
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg p-8">
          <h1 className="text-3xl font-bold text-[#2D1B3D] mb-6">Edit Adoption Form</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#FF7E67] focus:border-transparent"
                  required
                >
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                <input
                  ...
                  onChange={handleChange}
                  className="h-4 w-4 text-[#FF7E67] focus:ring-[#FF7E67] border-gray-300 rounded"
                />
            ...
            <div className="flex justify-end space-x-4">
              ...
              <button
                type="submit"
                className="px-6 py-2 bg-[#FF7E67] text-white rounded-lg hover:bg-[#2D1B3D] transition-colors"
              >
                Save Changes
              </button>
            </div>
