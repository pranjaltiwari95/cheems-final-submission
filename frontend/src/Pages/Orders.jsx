          ...
          >
                ...
                <div key={productIndex} className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-2 text-base text-amber-700">
                      <p className="text-lg text-[#FF7E67] font-bold">{currency}{product.price}</p>
            ...
            <div className="md:w-1/2 flex flex-col gap-4">
              ...
              <div className="text-sm text-amber-700">
                ...
                <p>Total: <span className="text-[#FF7E67] font-bold">{currency}{order.totalPrice}</span></p>
                  ...
                  <div className="flex items-center">
                    {hasReviewedProduct(order.products[0].productId) ? (
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-[#FF7E67] text-white rounded-full hover:bg-[#FF6C85] transition-colors duration-200"
                      >
                        Write Review
                      </button>
                    )}
            ...
            <div className="space-y-4">
              ...
              <div className="mt-4">
                <button
                  ...
                  className="w-full bg-[#FF7E67] hover:bg-[#FF6C85] text-white py-2 rounded-full font-bold shadow-md transition-all duration-200"
                >
                  Close
                </button>
              </div>
