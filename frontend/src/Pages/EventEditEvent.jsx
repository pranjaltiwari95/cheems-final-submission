...
const EditEvent = () => {
  ...
  if (error) {
    return (
      <div className="bg-gradient-to-br from-[#FFEADF] to-[#FFE1D6] min-h-screen flex flex-col pt-32 pb-20">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900">
              Edit <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A]">Event</span>
            </h1>
            <Link
