...
const AllPetsIcon = ({ isSelected }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512" className={isSelected ? "text-white" : "text-[#FF5C7A]"}>
...
const AdoptablePetList = () => {
    ...
    return (
      <div className="min-h-screen flex justify-center items-center">
        <div className="text-center">
          ...
          <button 
            className="bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white px-4 py-2 rounded-full hover:shadow-lg"
  ...
  return (
    <div className="bg-gradient-to-br from-[#FFEADF] to-[#FFE1D6] min-h-screen pt-24">
      <div className="container mx-auto px-4 py-8">
        {/* Header section with title */}
        <div className="mb-6">
          <h2 className="mx-auto max-w-lg text-center text-5xl font-extrabold text-gray-900 leading-tight">
            Meet Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A]">Adoptable Pets</span>
          </h2>
        </div>
        ...
        {/* Search Bar */}
            ...
            <input
              ...
              onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full px-6 py-4 rounded-full border border-[#FF5C7A] focus:outline-none focus:ring-2 focus:ring-[#FF5C7A]/20"
            />
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6 absolute right-4 top-1/2 transform -translate-y-1/2 text-[#FF5C7A]"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
              ...
              <button
                ...
                className={`
                  ...
                  ${speciesFilter === 'All' 
                    ...
                    : 'bg-white text-[#FF5C7A] border border-[#FF5C7A]'}
            ...
            <div className="flex flex-col items-center">
              <button
                ...
                className="flex items-center space-x-2 text-[#FF5C7A] hover:text-[#FF7E67] transition-colors"
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2 rounded-lg border-2 border-[#FF7E67] focus:border-[#FF5C7A] focus:ring-2 focus:ring-[#FF7E67]/20 outline-none"
                    >
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-1">
                  <div className="flex justify-between items-center mb-2">
                    <h2 className="text-xl font-semibold text-[#FF5C7A]">
                      {pet.name}
                    </h2>
                  ...
                  <div className="mt-auto">
                    <button 
                      ...
                      className="w-full bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white py-3 rounded-2xl
