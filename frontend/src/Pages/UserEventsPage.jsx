      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12 relative">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Upcoming <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A]">Pet Events</span>
          </h1>
          ...
          <div className="relative max-w-md mx-auto mt-6">
            ...
            <input
              ...
              className="w-full py-3 pl-12 pr-4 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#FF7E67] focus:border-transparent shadow-sm hover:shadow-md transition-all duration-300"
            />
          </div>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          ...
          <button
            ...
            className={`px-6 py-3 rounded-xl text-white flex items-center gap-2 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 ${
              token ? "bg-[#FF7E67] hover:bg-[#2D1B3D]" : "bg-gray-400 cursor-not-allowed"
            }`}
          >
            <FaCalendar size={20} />
        ...
        <div className="relative">
          <div className="flex justify-between items-center mb-6">
            ...
            <span className="bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white px-4 py-1 rounded-xl text-sm font-medium shadow-sm">
