...
const EditPetForm = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#FFE6DD] to-[#FFD8CC] pt-24 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-[#2D1B3D]">Loading pet data...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#FFE6DD] to-[#FFD8CC] pt-24 flex items-center justify-center">
        <div className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-[#2D1B3D] mb-4">Error</h2>
            <p className="text-gray-600 mb-6">{error}</p>
            <button
              onClick={() => navigate('/pet-owner-dashboard')}
              className="bg-[#FF5C7A] text-white px-6 py-2 rounded-lg hover:bg-[#FF7E67] transition-colors"
            >
              Return to Dashboard
            </button>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFE6DD] to-[#FFD8CC] pt-24 p-6">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="flex items-center justify-center mb-8">
            <Heart className="text-[#2D1B3D] mr-3" size={40} />
            <h2 className="text-3xl font-bold text-[#2D1B3D]">Edit Pet Listing</h2>
          </div>
