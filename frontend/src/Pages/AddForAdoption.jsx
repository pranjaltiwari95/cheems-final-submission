...
const PetOwnerForm = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#FFE6DD] to-[#FFD8CC] pt-24 flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#FF5C7A] mx-auto"></div>
          <p className="mt-4 text-[#2D1B3D]">Loading your information...</p>
        </div>
      </div>
    );
  }
  ...
  const SuccessMessage = () => (
    <div className="fixed inset-0  bg-opacity-50 flex items-center justify-center z-50 backdrop-blur-sm">
      <div className="bg-white p-12 rounded-3xl shadow-2xl text-center max-w-md">
        ...
        <h2 className="text-3xl font-bold text-[#2D1B3D] mb-4">Pet Successfully Listed!</h2>
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#FFE6DD] to-[#FFD8CC] pt-25 pb-12">
        {/* Page Title Section */}
          ...
          <div className="max-w-6xl mx-auto bg-white shadow-2xl rounded-3xl overflow-hidden flex border-2">
            ...
            <div className="w-full md:w-2/3 p-8 md:p-12 overflow-y-auto">
              <form onSubmit={handleSubmit} encType="multipart/form-data" className="space-y-8">
                ...
                <div className="bg-[#FFEADF]/50 rounded-2xl p-6 space-y-6">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="p-2 bg-[#FF5C7A]/10 rounded-xl">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#FF5C7A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                      </svg>
                    </div>
                    <h3 className="text-xl font-semibold text-[#2D1B3D]">Owner Information</h3>
                  </div>
                ...
                <div className="bg-[#FFEADF]/50 rounded-2xl p-6 space-y-6">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="p-2 bg-[#FF5C7A]/10 rounded-xl">
                      <PawPrint className="h-6 w-6 text-[#FF5C7A]" />
                    </div>
                    <h3 className="text-xl font-semibold text-[#2D1B3D]">Pet Information</h3>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        } focus:outline-none focus:ring-2 focus:ring-[#FF5C7A] transition-all duration-300 hover:shadow-md`}
                      />
                      {errors.petName && (
                        <p className="mt-2 text-sm text-red-500 flex items-center">
                  ...
                  <div className="mt-6">
                    ...
                    <div className="mt-2">
                      ...
                      } hover:border-[#FF5C7A] transition-colors`}>
                          ...
                          {previewImage ? (
                            ...
                            <>
                              ...
                              <div className="flex justify-center text-sm text-gray-600">
                                <label htmlFor="file-upload" className="relative cursor-pointer rounded-md font-medium text-[#FF5C7A] hover:text-[#FF7E67] focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-[#FF5C7A]">
                ...
                <div className="grid grid-cols-3 gap-4 mb-6">
                  <div className="flex items-center">
                    <input
                      ...
                      onChange={handleChange}
                      className="h-5 w-5 text-[#FF5C7A] focus:ring-[#FF7E67] border-gray-300 rounded"
                    />
                ...
                <div className="flex justify-center pt-6">
                  <button
                    type="submit"
                    className="group relative overflow-hidden rounded-xl bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] px-8 py-4 w-full
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-[#FF5C7A] to-[#FF7E67] opacity-0 group-hover:opacity-100 transition-opacity -z-10" />
                  </button>
                </div>
              </form>
            </div>
