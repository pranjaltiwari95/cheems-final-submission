...
const Notifications = () => {
  ...
  const getNotificationStyles = (notification) => {
    ...
    return {
      ...
      stripe: "bg-gradient-to-b from-[#FF7E67] to-[#FF5C7A]",
      text: "text-gray-800",
    };
  };
  ...
  if (error) {
    return (
      <div className="max-w-7xl mx-auto mt-32 px-6 py-6 bg-gradient-to-br from-[#FFEADF] to-[#FFE1D6]">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            My <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A]">Notifications</span>
          </h1>
        ...
        <div className="flex justify-center gap-4 mb-8 flex-wrap">
          {(adminNotifications.some(notif => !notif.read) || userNotifications.some(notif => !notif.read)) && (
            <button
              ...
              className="px-6 py-3 bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white rounded-xl hover:bg-[#2D1B3D] transition-colors shadow-md hover:shadow-lg transform hover:scale-105 duration-300"
            >
              Mark All as Read
            </button>
          )}
        ...
        {notifications.length === 0 ? (
          <div className="bg-white/80 rounded-2xl p-10 text-center shadow-lg border border-amber-100 transform transition hover:scale-105">
            ...
            <Link to="/events" className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white rounded-xl hover:bg-[#2D1B3D] transition-colors shadow-md hover:shadow-lg transform hover:scale-105 duration-300">
              Discover Events
            </Link>
          </div>
        ) : (
                        ...
                        <div className="p-4 md:flex-1 flex justify-between items-center">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <Link
                              ...
                              className="flex items-center bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white px-2 py-1 rounded hover:bg-[#2D1B3D] transition-colors text-xs font-medium"
                            >
