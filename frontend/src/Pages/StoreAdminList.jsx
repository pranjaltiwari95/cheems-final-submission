        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="pl-10 w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF7E67] focus:border-transparent"
              value={searchTerm}
      ...
      <td className="py-3 px-4">
        <div className="flex items-center justify-center gap-2">
          <input
            ...
            className="w-16 h-9 px-2 py-1 border border-gray-300 rounded-lg text-center focus:ring-2 focus:ring-[#FF7E67] focus:border-transparent"
            placeholder="Qty"
          />
          <button
            ...
            className={`inline-flex items-center justify-center px-3 py-2 rounded-lg transition-colors ${
              loading 
                ...
                : 'bg-[#FF7E67] hover:bg-[#2D1B3D] text-white'
            }`}
            title="Add Stock"
          >
