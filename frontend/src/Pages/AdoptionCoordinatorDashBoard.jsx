...
const PetAdoptionCoordinatorDashboard = () => {
    ...
    <div className="p-6 bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex space-x-3">
          <button 
            className="flex items-center bg-gradient-to-r from-[#2D1B3D] to-[#FF7E67] text-white px-5 py-2 rounded-full shadow-lg hover:scale-105 transition-transform"
              ...
              adoptionForms
                ...
                .map((form) => (
                  <div 
                    key={form._id} 
                    className={`bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition ${
                      form._id === highlightedFormId ? 'ring-4 ring-[#FF7E67] animate-pulse' : ''
                    }`}
                  >
                    <div className="flex flex-col md:flex-row gap-6">
                      {/* Left Section - Pet Image and Basic Info */}
          ...
          {(lostFoundSection === 'lost' ? lostPets : foundPets).length === 0 ? (
            ...
            (lostFoundSection === 'lost' ? lostPets : foundPets).map((pet) => (
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="text-xl font-semibold text-[#2D1B3D] mb-2">{pet.petName}</h3>
      ...
      <div className="p-6 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2 bg-[#FF7E67] text-white rounded-lg shadow hover:bg-[#2D1B3D] transition-colors font-semibold"
          >
            <FileText size={18} />
            Download Report
          </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-lg p-6 space-y-4 transform transition-all hover:scale-105">
            <div className="flex justify-between items-center">
              <HeartHandshake className="text-[#FF7E67]" size={40} />
            ...
            <div className="h-2 w-full bg-gray-100 rounded-full">
              <div 
                className="h-2 bg-[#FF7E67] rounded-full" 
                style={{ width: '100%' }}
              ></div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
              <Calendar className="mr-2 text-[#FF7E67]" />
              This Month's Statistics
            </h3>
            <div className="space-y-4">
              <div className="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
                <span className="text-gray-600">Monthly Adoptions</span>
                <span className="text-2xl font-bold text-[#FF7E67]">{monthlyAdoptions}</span>
              </div>
              <div className="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
              <TrendingUp className="mr-2 text-[#FF7E67]" />
              Performance Metrics
            </h3>
            <div className="space-y-4">
              <div className="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
                <span className="text-gray-600">Average Processing Time</span>
                <span className="text-2xl font-bold text-[#FF7E67]">3.5 days</span>
              </div>
              <div className="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
              <PieChart className="mr-2 text-[#FF7E67]" />
              Application Status
            </h3>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
              <Home className="mr-2 text-[#FF7E67]" />
              Visit Status
            </h3>
            <div className="space-y-3">
              <div className="flex justify-between items-center">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
              <Dog className="mr-2 text-[#FF7E67]" />
              Pet Status
            </h3>
            <div className="space-y-3">
              <div className="flex justify-between items-center">
        ...
        <div className="mb-8">
          <h3 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
            <MapPin className="mr-2 text-[#FF7E67]" />
            Lost & Found Reports
          </h3>
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      {/* Sidebar */}
      <div className="w-72 bg-gradient-to-b from-[#2D1B3D] to-[#FF7E67] shadow-2xl flex flex-col justify-between">
        <div>
