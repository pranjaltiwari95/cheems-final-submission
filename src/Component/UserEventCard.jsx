  ...
  return (
    <div className="overflow-hidden rounded-2xl bg-white/80 shadow-lg flex flex-col transition-all duration-300 hover:shadow-xl hover:scale-105 border border-gray-100 group transform">
      <div className="relative pt-[56.25%]">
        ...
        <div className="absolute top-4 right-4 bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white px-3 py-1 rounded-xl text-sm font-semibold shadow-sm">
          {formattedDate}
        </div>
        {isSoldOut && (
      ...
      <div className="p-6 flex-grow flex flex-col">
        <div className="mb-3">
          <h3 className="text-xl font-semibold text-[#FF5C7A] line-clamp-2">{event.title}</h3>
        </div>
        ...
        <div className="space-y-2 mb-4">
          ...
          <div className="flex items-center">
            ...
            <span className="text-sm font-medium text-gray-700">
              ...
              {event.maxAttendees && (
                <span className="ml-2 text-[#FF7E67]">
          ...
          <button
            ...
            className={`w-full py-2.5 text-center font-medium rounded-xl transition-all flex items-center justify-center shadow-md hover:shadow-lg ${
              isSoldOut
                ...
                : "bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white hover:bg-[#2D1B3D] transform hover:scale-105"
            }`}
          >
