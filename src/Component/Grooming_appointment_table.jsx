        ...
        <table className="w-full table-fixed">
          <thead className="bg-amber-950 text-white">
            <tr>
              ...
              <th className="w-[120px] px-4 py-3 text-left text-xs font-medium uppercase tracking-wider">Groomer ID</th>
            ...
            {filteredAppointments.length === 0 ? (
              ...
              filteredAppointments.map((appointment, index) => (
                ...
                >
                  ...
                  <td className="w-[120px] px-4 py-3 text-sm truncate">{appointment.groomerId || 'N/A'}</td> {/* Corrected to groomerId */}
