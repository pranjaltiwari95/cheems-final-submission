        ...
        <div className="mb-6">
          ...
          <div className="space-y-2 text-gray-700 mb-4">
            <p>
              ...
              <span className="text-[#FF5C7A]">₹{registration.eventId.price.toFixed(2)}</span>
            </p>
            <p>
            ...
            <p>
              ...
              <span className="text-[#FF5C7A]">{registration.tickets}</span>
            </p>
            <p>
              <span className="font-semibold">Total Cost:</span>{" "}
              <span className="text-[#FF5C7A]">₹{(registration.eventId.price * tickets).toFixed(2)}</span>
            </p>
          </div>
          <div>
