...
export default function ReportPageOne() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFEADF] to-[#FFE1D6] px-6 py-12 sm:py-16 lg:px-8">
      ...
      {reportData ? (
        <div ref={reportRef} className="mx-auto mt-12 max-w-5xl">
          <div className="text-center mb-10 animate-slide-in" style={{ animationDelay: '0.3s' }}>
            <h3 className="text-3xl font-bold text-amber-950 tracking-tight">Cheems Appointment Insights</h3>
