...
const EventDetailsHeader = ({ event }) => {
  ...
  return (
    <div className="bg-white/80 rounded-2xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl">
      ...
      <div className="bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white p-6 rounded-xl shadow-lg mb-8 flex items-center gap-4 transform transition hover:scale-105">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-gray-600 mb-10">
        <div className="flex items-center bg-gradient-to-r from-[#FFEADF] to-[#FFE1D6] p-4 rounded-xl shadow-sm transition-transform duration-300 hover:scale-105">
          <FaClock className="text-[#FF7E67] mr-4" size={24} />
          <div>
            <span className="text-base font-semibold text-[#FF5C7A]">
              {formattedDate} at {event.time}
            </span>
          </div>
        </div>
        <div className="flex items-center bg-gradient-to-r from-[#FFEADF] to-[#FFE1D6] p-4 rounded-xl shadow-sm transition-transform duration-300 hover:scale-105">
          <FaMapMarkerAlt className="text-[#FF7E67] mr-4" size={24} />
          <div>
            <span className="text-base font-semibold text-[#FF5C7A]">{event.location}</span>
          </div>
        </div>
        <div className="flex items-center bg-gradient-to-r from-[#FFEADF] to-[#FFE1D6] p-4 rounded-xl shadow-sm transition-transform duration-300 hover:scale-105">
          <FaTicketAlt className="text-[#FF7E67] mr-4" size={24} />
          <div>
            <span className="text-base font-semibold text-[#FF5C7A]">
        ...
        <div className="flex items-center bg-gradient-to-r from-[#FFEADF] to-[#FFE1D6] p-4 rounded-xl shadow-sm transition-transform duration-300 hover:scale-105">
          <FaUsers className="text-[#FF7E67] mr-4" size={24} />
          <div>
            <span className="text-base font-semibold text-[#FF5C7A]">
        ...
        <div className="flex items-center bg-gradient-to-r from-[#FFEADF] to-[#FFE1D6] p-4 rounded-xl shadow-sm transition-transform duration-300 hover:scale-105">
          <FaCheckCircle className="text-[#FF7E67] mr-4" size={24} />
          <div>
            <span className="text-base font-semibold text-[#FF5C7A]">
