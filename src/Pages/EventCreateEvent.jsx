        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">
              Create a New <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A]">Event</span>
            </h1>
          ...
          <div className="bg-amber-50 rounded-2xl shadow-lg p-6 mb-8 border border-amber-200">
            ...
            <ul className="list-disc list-inside space-y-2 text-base text-gray-700">
              ...
              <li>
                <span className="font-medium">Price:</span> Enter the price per ticket in rupees (e.g., 500.00). Must be a positive number.
              </li>
              <li>
