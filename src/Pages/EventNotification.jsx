...
const Notification = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-gradient-to-br from-[#FFEADF] to-[#FFE1D6] pt-32 pb-20">
      <div className="relative z-10 flex-grow max-w-6xl mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-[#2F1B3C]">
            Event <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A]">Analytics</span>
          </h1>
          <Link
            to="/admin/redirect/event_manager/events"
            className="flex items-center px-6 py-3 bg-[#FFF8F0] hover:bg-[#FFE4D6] text-[#2F1B3C] rounded-3xl transition-all duration-300 border-2 border-[#FF7E67]/20 shadow-2xl hover:shadow-3xl transform hover:scale-102"
          >
            <svg
        ...
        {loading ? (
          <div className="bg-[#FFF8F0] rounded-3xl shadow-2xl p-8 border-2 border-[#FF7E67]/20 hover:shadow-3xl transition-all duration-300">
            <div className="text-center">
              <div className="inline-block animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-[#FF7E67]"></div>
              <p className="text-[#2F1B3C] text-base mt-4">Loading analytics...</p>
            </div>
          </div>
        ) : error ? (
          <div className="bg-[#FFF8F0] rounded-3xl shadow-2xl p-8 border-2 border-[#FF7E67]/20 hover:shadow-3xl transition-all duration-300">
          ...
          <div className="space-y-8">
            {/* Summary Card */}
            <div className="bg-[#FFF8F0] rounded-3xl shadow-2xl p-8 border-2 border-[#FF7E67]/20 hover:shadow-3xl transition-all duration-300">
              <h2 className="text-2xl font-semibold text-[#2F1B3C] bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white rounded-t-3xl p-6 mb-6 -mx-8 -mt-8">
                Overview
              </h2>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div className="bg-gradient-to-r from-[#FFF8F0] to-[#FFE4D6] p-6 rounded-2xl shadow-md transform transition hover:scale-102">
                  <p className="text-base text-[#2F1B3C]">Total Registrations</p>
                  <p className="text-3xl font-bold text-[#FF7E67]">{totalRegistrations}</p>
                </div>
                <div className="bg-gradient-to-r from-[#FFF8F0] to-[#FFE4D6] p-6 rounded-2xl shadow-md transform transition hover:scale-102">
                  <p className="text-base text-[#2F1B3C]">Total Revenue</p>
                  <p className="text-3xl font-bold text-[#FF7E67]">${totalRevenue.toLocaleString()}</p>
                </div>
                <div className="bg-gradient-to-r from-[#FFF8F0] to-[#FFE4D6] p-6 rounded-2xl shadow-md transform transition hover:scale-102">
                  <p className="text-base text-[#2F1B3C]">Total Refunds</p>
                  <p className="text-3xl font-bold text-[#FF7E67]">${totalRefunds.toLocaleString()}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#FFF8F0] rounded-3xl shadow-2xl p-8 border-2 border-[#FF7E67]/20 hover:shadow-3xl transition-all duration-300">
              <div className="flex justify-between items-center mb-6">
                ...
                {(dateRange.start || dateRange.end) && (
                  <button
                    ...
                    className="text-[#FF7E67] hover:text-[#FF5C7A] text-lg font-medium transition duration-300"
                  >
                    Reset Filters
                  </button>
                )}
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex-1">
                  <label className="block text-lg font-medium text-[#2F1B3C]">Start Date</label>
                  <input
                    type="date"
                    value={dateRange.start}
                    onChange={(e) => setDateRange({ ...dateRange, start: e.target.value })}
                    className="mt-2 block w-full rounded-2xl border-gray-300 shadow-sm p-4 focus:ring-2 focus:ring-[#FF7E67] focus:border-transparent text-base text-[#2F1B3C] transition-all duration-300 bg-white"
                  />
                </div>
                <div className="flex-1">
                  <label className="block text-lg font-medium text-[#2F1B3C]">End Date</label>
                  <input
                    type="date"
                    value={dateRange.end}
            ...
            <div className="flex flex-wrap gap-4">
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white rounded-2xl hover:bg-[#2D1B3D] transition-all duration-300 transform hover:scale-102 shadow-2xl hover:shadow-3xl"
              >
            ...
            <div className="bg-[#FFF8F0] rounded-3xl shadow-2xl p-8 border-2 border-[#FF7E67]/20 hover:shadow-3xl transition-all duration-300">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-semibold text-[#2F1B3C] bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white rounded-t-3xl p-6 -mx-8 -mt-8 w-full">
                ...
                <button
                  ...
                  className={`px-6 py-3 rounded-2xl text-white font-medium transition-all duration-300 shadow-2xl ${
                    refundedRegistrations.length === 0
                      ...
                      : "bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] hover:bg-[#2D1B3D] hover:shadow-3xl transform hover:scale-102"
                  }`}
                >
              ...
              {refundedRegistrations.length > 0 ? (
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gradient-to-r from-[#FFF8F0] to-[#FFE4D6]">
                      <tr>
                        <th className="px-6 py-4 text-left text-sm font-medium text-[#2F1B3C] uppercase tracking-wider">Event</th>
                        <th className="px-6 py-4 text-left text-sm font-medium text-[#2F1B3C] uppercase tracking-wider">User</th>
                        <th className="px-6 py-4 text-left text-sm font-medium text-[#2F1B3C] uppercase tracking-wider">Email</th>
                        <th className="px-6 py-4 text-left text-sm font-medium text-[#2F1B3C] uppercase tracking-wider">Tickets</th>
                        <th className="px-6 py-4 text-left text-sm font-medium text-[#2F1B3C] uppercase tracking-wider">Refund Amount</th>
                        <th className="px-6 py-4 text-left text-sm font-medium text-[#2F1B3C] uppercase tracking-wider">Cancelled At</th>
                      </tr>
                    </thead>
                    <tbody className="bg-white divide-y divide-gray-200">
                      {refundedRegistrations.map((item, index) => (
                        <tr key={index} className="hover:bg-gray-50 transition-all duration-300">
                          <td className="px-6 py-4 whitespace-nowrap text-base text-[#2F1B3C]">{item.eventTitle}</td>
                          <td className="px-6 py-4 whitespace-nowrap text-base text-[#2F1B3C]">{item.userName}</td>
                          <td className="px-6 py-4 whitespace-nowrap text-base text-[#2F1B3C]">{item.userEmail}</td>
                          <td className="px-6 py-4 whitespace-nowrap text-base text-[#2F1B3C]">{item.tickets}</td>
                          <td className="px-6 py-4 whitespace-nowrap text-base text-[#2F1B3C]">
                            {item.refundAmount.toLocaleString("en-IN", { style: "currency", currency: "INR" })}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-base text-[#2F1B3C]">
                ...
                <div className="text-center py-8 bg-gradient-to-r from-[#FFF8F0] to-[#FFE4D6] rounded-2xl">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p className="text-[#2F1B3C] text-base">No refunded registrations found.</p>
                </div>
              )}
            </div>
          </div>
