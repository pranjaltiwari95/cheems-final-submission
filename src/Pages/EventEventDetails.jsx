      ...
      <div className="max-w-5xl w-full mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900">
            Event <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A]">Details</span>
          </h1>
          <Link
        ...
        <div className="bg-white/90 rounded-2xl shadow-xl p-8 border border-amber-100 mb-8 transition-all duration-300 hover:shadow-2xl">
          <h2 className="text-2xl font-bold text-white bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] rounded-t-xl p-4 -m-8 mb-6">
            Event Overview
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Status Card */}
            <div className="bg-gradient-to-r from-[#FFEADF] to-[#FFE1D6] p-4 rounded-xl shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-300">
