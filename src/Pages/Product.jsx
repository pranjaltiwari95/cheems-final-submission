        ...
        <div className='bg-amber-50 min-h-screen pt-32 px-4 md:px-16 transition-opacity ease-in duration-500 opacity-100'>
            <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
                    ...
                    <div className='flex sm:flex-col overflow-x-auto sm:overflow-y-scroll justify-between sm:justify-normal sm:w-[18.7%] w-full'>
                        {ProductData.image.map((item, index) => (
                            <img
                                ...
                                src={item}
                                key={index}
                                className='w-[24%] sm:w-full sm:mb-3 flex-shrink-0 cursor-pointer rounded-xl border border-amber-200 hover:border-[#FF7E67] transition-all duration-200'
                ...
                <div className='flex-1'>
                    ...
                    <p className='mt-5 text-3xl font-bold text-[#FF7E67]'>{currency}{ProductData.price}</p>
                        ...
                        <div className='flex gap-2'>
                            {ProductData.sizes?.map((item, index) => (
                                <button
                                    ...
                                    className={`border py-2 px-4 bg-amber-100 rounded-full text-amber-900 font-medium shadow-sm transition-all duration-200 ${item === size ? 'border-[#FF7E67] bg-[#FF7E67] text-white' : 'border-amber-200 hover:border-[#FF7E67] hover:bg-amber-200'}`}
                                    key={index}
                                >
                                    {item}
                                </button>
