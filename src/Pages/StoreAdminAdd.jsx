...
const StoreAdminAdd = ({ token }) => {
  ...
  const generateSalesReport = async () => {
    try {
      ...
      doc.setFontSize(20);
      doc.setTextColor(128, 83, 59); // #2D1B3D
      doc.text("Cheems - Sales Report", 14, 20);
      ...
      doc.setFontSize(16);
      doc.setTextColor(208, 136, 96); // #FF7E67
      ...
      // Save PDF
      doc.save(`Cheems-Sales-Report-${new Date().toISOString().slice(0, 10)}.pdf`);
    ...
    <div className="p-6 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-6 gap-4">
        <h2 className="text-3xl font-bold text-gray-800 flex items-center">
          <PlusCircle className="mr-3 text-[#2D1B3D]" size={28} />
          Add New Product
        </h2>
        ...
        <div className="bg-white p-4 rounded-xl shadow-md flex flex-col sm:flex-row gap-3">
          <div>
            ...
            <input 
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF7E67] focus:border-transparent"
            />
          </div>
          <div>
            ...
            <button
              ...
              className={`w-full px-4 py-2 rounded-lg flex items-center justify-center transition-all ${
                generatingReport 
                  ...
                  : 'bg-gradient-to-r from-[#2D1B3D] to-[#FF7E67] text-white hover:shadow-md'
              }`}
            >
              {generatingReport ? (
                <>
        ...
        <form className="flex flex-col w-full items-start gap-6" onSubmit={handleSubmit}>
          <div className="w-full">
            <p className="mb-2 font-medium text-gray-700 flex items-center">
              <Upload className="mr-2 text-[#FF7E67]" size={18} />
              Product Images
              <span className="text-red-500 ml-1">*</span>
            </p>
            <div className="flex flex-wrap gap-4">
              <label htmlFor="image1" className="cursor-pointer">
                <div className="w-28 h-28 border-2 border-dashed border-[#FF7E67] rounded-lg flex items-center justify-center bg-[#FF7E67]/5 hover:bg-[#FF7E67]/10 transition-colors">
                  {image1 ? (
                    <img
                    ...
                    <span className="text-[#FF7E67] font-bold text-xl">+</span>
                  )}
                </div>
          ...
          <div className="w-full">
            <p className="mb-2 font-medium text-gray-700 flex items-center">
              <Tag className="mr-2 text-[#FF7E67]" size={18} />
              Product Name
              <span className="text-red-500 ml-1">*</span>
            </p>
            <input
              className="w-full max-w-[600px] px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF7E67] focus:border-transparent outline-none transition-all"
              type="text"
          ...
          <div className="w-full">
            <p className="mb-2 font-medium text-gray-700 flex items-center">
              <Info className="mr-2 text-[#FF7E67]" size={18} />
              Product Description
              <span className="text-red-500 ml-1">*</span>
            </p>
            <textarea
              className="w-full max-w-[600px] px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF7E67] focus:border-transparent outline-none transition-all min-h-[120px]"
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <p className="mb-2 font-medium text-gray-700 flex items-center">
                <Package className="mr-2 text-[#FF7E67]" size={18} />
                Category & Subcategory
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <select
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF7E67] focus:border-transparent outline-none transition-all"
                    value={category}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <div className="relative">
                    ...
                    <input
                      className="w-full pl-8 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF7E67] focus:border-transparent outline-none transition-all"
                      type="number"
                      placeholder="0.00"
                      step="0.01"
                      min="0"
          ...
          <div>
            <p className="mb-2 font-medium text-gray-700 flex items-center">
              <Layers className="mr-2 text-[#FF7E67]" size={18} />
              ...
              {['S', 'M', 'L', 'XL', 'XXL'].map(size => (
                <div 
                  ...
                  className={`
                    ...
                    ${sizes.includes(size) 
                      ? 'bg-gradient-to-r from-[#2D1B3D] to-[#FF7E67] text-white shadow-md' 
          ...
          <div className="flex items-center mt-2">
            <div 
              ...
              className={`
                ...
                ${bestseller 
                  ? 'bg-gradient-to-r from-[#2D1B3D] to-[#FF7E67] text-white' 
          ...
          <button
            type="submit"
            className="mt-6 bg-gradient-to-r from-[#2D1B3D] to-[#FF7E67] text-white px-8 py-3 rounded-lg shadow-md hover:shadow-lg transform hover:scale-[1.02] transition-all font-semibold"
          >
