  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-gradient-to-br from-[#FFEADF] to-[#FFE1D6] pt-32 pb-20">
      ...
      <div className="absolute top-0 left-0 w-full h-full opacity-5 pointer-events-none">
        <div className="absolute top-0 right-0 w-80 h-80 bg-[#FF7E67] rounded-full mix-blend-multiply filter blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-60 h-60 bg-[#FF7E67] rounded-full mix-blend-multiply filter blur-3xl"></div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-2">
              My <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A]">Events</span>
            </h2>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-8">
            <div className="relative w-full md:w-1/2">
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#FF7E67] focus:border-transparent text-base pl-10"
              />
              <svg
            ...
            <Link
              ...
              className="flex items-center px-6 py-3 bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white rounded-xl hover:bg-[#2D1B3D] transition-colors shadow-md hover:shadow-lg transform hover:scale-105 duration-300"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          {filteredEvents.length > 0 ? (
            ...
            <div className="text-center py-16 bg-white/80 rounded-2xl shadow-lg border border-amber-100">
              ...
              <Link
                to="/create-event"
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white rounded-xl hover:bg-[#2D1B3D] transition-colors shadow-md hover:shadow-lg transform hover:scale-105 duration-300"
              >
