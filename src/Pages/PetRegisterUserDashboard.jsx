    ...
    <div className="min-h-screen bg-gradient-to-br from-[#FFE6DD] to-[#FFD8CC] pt-24 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-[#2D1B3D]">My Adoption Dashboard</h1>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <h2 className="text-2xl font-semibold text-[#2D1B3D] mb-4 flex items-center">
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="flex-shrink-0">
                        ...
                        <div className="mt-4 text-center">
                          <h3 className="text-xl font-bold text-[#2D1B3D]">{form.petName}</h3>
                      ...
                      <div className="flex-grow">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="space-y-3">
                            <div className="flex items-center">
                              <span className="w-2 h-2 bg-[#FF7E67] rounded-full mr-2"></span>
                        ...
                        {relatedVisits.length > 0 && (
                          <div className="mt-6 border-t border-gray-100 pt-4">
                            <h4 className="text-lg font-semibold text-[#2D1B3D] mb-3 flex items-center">
                        ...
                        {form.status !== 'approved' && form.status !== 'rejected' && (
                          <div className="mt-4 flex justify-end space-x-3">
                            <button
                              ...
                              className="px-4 py-2 bg-[#FF7E67] text-white rounded-lg hover:bg-[#2D1B3D] transition-colors flex items-center space-x-2"
                            >
                              <Edit size={18} />
                              <span>Edit</span>
                            </button>
