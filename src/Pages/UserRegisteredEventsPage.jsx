...
const UserRegisteredEventsPage = () => {
  ...
  if (loading) {
    return (
      <div className="max-w-7xl mx-auto mt-32 px-6 py-20 text-center bg-gradient-to-br from-[#FFEADF] to-[#FFE1D6]">
        <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#FF7E67] mx-auto"></div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            My <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A]">
              Registered Events
            </span>
          </h1>
        ...
        <div className="flex justify-center gap-4 mb-8 flex-wrap">
          <button
            ...
            className={`px-6 py-3 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 ${
              filter === "active"
                ? "bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white"
          ...
          <Link
            to="/events"
            className="flex items-center px-6 py-3 bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white rounded-xl hover:bg-[#2D1B3D] transition-colors shadow-lg hover:shadow-xl transform hover:scale-105 duration-300"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        {!error && filteredRegistrations.length === 0 ? (
          <div className="bg-white/80 rounded-2xl p-10 text-center shadow-lg transform transition hover:scale-105">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-20 w-20 mx-auto text-[#FF7E67] mb-6 opacity-80"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
            ...
            <Link
              to="/events"
              className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white rounded-xl hover:bg-[#2D1B3D] transition-colors shadow-lg hover:shadow-xl transform hover:scale-105 duration-300"
            >
              Discover Events
            </Link>
          </div>
              ...
              >
                <div
                  className={`flex items-center justify-center w-28 shrink-0 ${
                    registration.status?.toLowerCase() === "active"
                      ? "bg-gradient-to-b from-[#FF7E67] to-[#FF5C7A]"
                ...
                <div className="p-6 flex-1">
                  <div className="flex justify-between items-start mb-3">
                    <h3 className="text-2xl font-semibold text-[#FF5C7A]">
                  ...
                  <div className="flex flex-wrap text-sm text-gray-600 mb-4 gap-4">
                    <div className="flex items-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-5 w-5 mr-2 text-[#FF7E67]"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="font-medium">
                        Total: ₹{((registration.eventId?.price || 0) * registration.tickets).toFixed(2)}
                      </span>
                    </div>
                  </div>
                  {filter === "active" && (
                  ...
                  {filter === "active" && (
                    <div className="flex flex-wrap items-center gap-3">
                      <Link
                        ...
                        className="flex items-center bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white px-4 py-2 rounded-xl hover:bg-[#2D1B3D] transition-colors shadow-sm hover:shadow-md transform hover:scale-105 duration-300"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-5 w-5 mr-2"
