...
const PetAdoptionForm = () => {
  ...
  const SuccessMessage = () => (
    <div className="fixed inset-0  bg-opacity-50 flex items-center justify-center z-50 backdrop-blur-sm">
      <div className="bg-white p-12 rounded-3xl shadow-2xl text-center max-w-md">
        ...
        <h2 className="text-3xl font-bold text-[#2D1B3D] mb-4">Application Submitted!</h2>
        ...
        <button 
          ...
          className="bg-[#FF5C7A] text-white px-8 py-3 rounded-xl hover:bg-[#FF7E67] transition-colors"
        >
          Close
        </button>
      </div>
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#FFE6DD] to-[#FFD8CC] pt-24 flex items-center justify-center p-6">
        <div className="w-full max-w-10xl bg-white shadow-2xl rounded-3xl overflow-hidden flex border-2 border-[] mt-6">
          ...
          <div className="w-1/2 p-12 overflow-y-auto bg-white">
            <div className="flex items-center justify-center mb-8">
              <Heart className="text-[#2D1B3D] mr-3" size={50} />
              <h2 className="text-3xl font-bold text-[#2D1B3D]">Pet Adoption Application</h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 rounded-xl border-2 border-[] focus:outline-none focus:ring-2 focus:ring-[#FF5C7A] transition-all duration-300 hover:shadow-md"
                ...
                <button
                  ...
                  className={`w-full px-8 py-4 rounded-xl text-lg font-semibold flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 ${
                    isSubmitting 
                      ...
                      : 'bg-[#FF5C7A] hover:bg-[#FF7E67] text-white'
                  }`}
                >
                  {isSubmitting ? (
                    <>
