      ...
      <div className="min-h-screen bg-gradient-to-br from-[#FFEADF] to-[#FFEADF] py-8 mt-20">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#FF7E67] mx-auto"></div>
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-[#2D1B3D] mb-4">
                {pet.petName || 'Unknown Pet'}
              </h1>
              
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  <MapPin className="text-[#FF7E67]" />
                ...
                <div className="flex items-center gap-2">
                  <Calendar className="text-[#FF7E67]" />
                  <p className="text-gray-600">
                ...
                <div className="flex items-center gap-2">
                  <Phone className="text-[#FF7E67]" />
                  <p className="text-gray-600">Contact: {pet.contactNumber}</p>
                </div>

                <div className="flex items-center gap-2">
                  <Mail className="text-[#FF7E67]" />
                  <p className="text-gray-600">Email: {pet.email}</p>
                </div>

                <div>
                  <h3 className="text-lg font-semibold text-[#2D1B3D] mb-2">Description</h3>
                  <p className="text-gray-600">{pet.description}</p>
                </div>

                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg font-semibold text-[#2D1B3D] mb-2">Type</h3>
                    <p className="text-gray-600 capitalize">{pet.petType}</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-[#2D1B3D] mb-2">Breed</h3>
                    <p className="text-gray-600">{pet.breed}</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-[#2D1B3D] mb-2">Color</h3>
                    <p className="text-gray-600">{pet.color}</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-[#2D1B3D] mb-2">Age</h3>
                    <p className="text-gray-600">{pet.age}</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-[#2D1B3D] mb-2">Gender</h3>
              ...
              <div className="mt-6 flex justify-end">
                <button
                  ...
                  className="bg-[#FF7E67] text-white px-6 py-3 rounded-xl hover:bg-[#2D1B3D] transition-colors"
                >
                  Back to List
                </button>
              </div>
