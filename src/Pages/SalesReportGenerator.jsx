  ...
  if (loading) {
    return (
      <div className="p-6 flex justify-center items-center min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#FF7E67]"></div>
      </div>
    );
  }
      ...
      <div className="p-6 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-md p-6">
          ...
          <button
            ...
            className="mx-auto block bg-gradient-to-r from-[#2D1B3D] to-[#FF7E67] text-white px-4 py-2 rounded-lg shadow-md hover:shadow-lg"
          >
            Try Again
          </button>
        </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
          <h2 className="text-3xl font-bold text-gray-800 flex items-center">
            <FileText className="mr-3 text-[#FF7E67]" size={32} />
            Sales Report
          </h2>
          
          <button
            onClick={handleRefresh}
            className="bg-white text-[#FF7E67] px-4 py-2 rounded-lg border border-[#FF7E67] hover:bg-[#FF7E67]/5 transition flex items-center"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
            <div className="col-span-1 md:col-span-2">
              ...
              <select
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF7E67] focus:border-transparent"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="bg-white rounded-xl shadow-md p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
              <PackageCheck className="mr-2 text-[#FF7E67]" size={20} />
              Order Status
            </h3>
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
              <Tag className="mr-2 text-[#FF7E67]" size={20} />
              Top Products
            </h3>
            ...
            <div className="space-y-4">
              {stats.topProducts.map((product, index) => (
                <div key={index} className="flex items-center justify-between">
                  <div className="flex items-center">
                    <div className="w-6 h-6 rounded-full bg-[#FF7E67]/10 flex items-center justify-center text-xs font-bold text-[#FF7E67] mr-3">
                      {index + 1}
                    </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
            <ShoppingBag className="mr-2 text-[#FF7E67]" size={20} />
            Recent Orders
          </h3>
...
const getStatusColor = (status) => {
  switch(status) {
    ...
    default:
      return 'bg-[#FF7E67]/10 text-[#FF7E67]';
  }
};
