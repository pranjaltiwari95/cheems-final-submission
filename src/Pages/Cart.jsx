          ...
          return (
            ...
            >
              <div className='ml-5 flex items-start gap-6'>
                ...
                <div>
                  ...
                  <div className='flex items-center gap-5 mt-2'>
                    <p className='text-[#FF7E67] font-bold'>
                      {currency}
              ...
              <input
                ...
                className='border border-amber-200 rounded-md max-w-10 sm:max-w-20 px-1 sm:px-2 py-1 focus:ring-2 focus:ring-[#FF7E67] focus:border-[#FF7E67]'
                type='number'
                min={1}
        ...
        <div className='w-full sm:w-[450px] ml-10 mr-10'>
          ...
          <div className='w-full text-end'>
            <button
              ...
              className='bg-[#FF7E67] hover:bg-[#FF6C85] text-white font-bold rounded-full shadow-md text-base my-8 px-8 py-3 transition-all duration-200 mr-20'
            >
              PROCEED TO CHECKOUT
            </button>
          </div>
