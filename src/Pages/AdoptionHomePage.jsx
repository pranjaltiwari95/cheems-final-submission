...
const AdoptionHomePage = () => {
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-br from-[#FFEADF] to-[#FFEADF] py-8 pt-8">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-4">
            <button
              onClick={handleAddPetClick}
              className="bg-[#FF7E67] text-white px-6 py-3 rounded-xl hover:bg-[#2D1B3D] transition-colors flex items-center gap-2 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
            >
              <Plus size={20} />
      ...
      <div className="bg-gradient-to-br from-[#FFEADF] to-[#FFE1D6] py-16 overflow-hidden">
        <div className=" mx-2 px-4 justify-center">
          <div className="text-center mb-12 relative">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Featured <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A]">Pets</span>
            </h2>
            ...
            <button
              onClick={() => navigate('/info_adoptable_pet')}
              className="absolute top-0 right-0 bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white px-6 py-2 rounded-xl 
          ...
          {loading ? (
            ...
            <div className="relative">
              ...
              <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-[#FFEADF] to-transparent z-10"></div>
              <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-[#FFEADF] to-transparent z-10"></div>
                ...
                <div className="flex animate-scroll mt-10 mb-10">
                  ...
                  {featuredPets.map((pet) => (
                    ...
                    >
                      ...
                      <div className="p-6">
                        <h3 className="text-xl font-semibold text-[#FF5C7A] mb-2">{pet.petName}</h3>
                        ...
                        <button
                          ...
                          className="w-full bg-gradient-to-r from-[#FF7E67] to-[#FF5C7A] text-white py-2 rounded-xl hover:shadow-lg transition-all duration-300"
                        >
                          Adopt Me
                        </button>
                      </div>
